...
namespace CardGames.Models.Santase
{
	class SantaseCardPoints
    {
        public static IDictionary<string, int> CardPoints = new Dictionary<string, int>() { 
			...
			{Suits.Clubs.ToString() +  Values.Nine.ToString(), 0 },
			{Suits.Clubs.ToString() +   Values.Ten.ToString(), 10},
			{Suits.Clubs.ToString() +  Values.Jack.ToString(), 2},
			{Suits.Clubs.ToString() + Values.Queen.ToString(), 3},
			{Suits.Clubs.ToString() +  Values.King.ToString(), 4},
			...
			{Suits.Hearts.ToString() +  Values.Nine.ToString(), 0 },
			{Suits.Hearts.ToString() +   Values.Ten.ToString(), 10},
			{Suits.Hearts.ToString() +  Values.Jack.ToString(), 2},
			{Suits.Hearts.ToString() + Values.Queen.ToString(), 3},
			{Suits.Hearts.ToString() +  Values.King.ToString(), 4},
			...
			{Suits.Diamonds.ToString() +  Values.Nine.ToString(), 0 },
			{Suits.Diamonds.ToString() +   Values.Ten.ToString(), 10},
			{Suits.Diamonds.ToString() +  Values.Jack.ToString(), 2},
			{Suits.Diamonds.ToString() + Values.Queen.ToString(), 3},
			{Suits.Diamonds.ToString() +  Values.King.ToString(), 4},
			...
			{Suits.Spades.ToString() +  Values.Nine.ToString(), 0 },
			{Suits.Spades.ToString() +   Values.Ten.ToString(), 10},
			{Suits.Spades.ToString() +  Values.Jack.ToString(), 2},
			{Suits.Spades.ToString() + Values.Queen.ToString(), 3},
			{Suits.Spades.ToString() +  Values.King.ToString(), 4},
